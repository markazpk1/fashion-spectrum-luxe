...
const revenueData = [
  ...
  { name: "Feb", revenue: 38000, orders: 98 },
  { name: "Mar", revenue: 55000, orders: 156 },
  { name: "Apr", revenue: 47000, orders: 132 },
  { name: "May", revenue: 61000, orders: 178 },
  { name: "Jun", revenue: 58000, orders: 165 },
  { name: "Jul", revenue: 72000, orders: 210 },
];

const categoryData = [
  { name: "Dresses", value: 35, color: "hsl(0, 72%, 40%)" },
  { name: "Kaftans", value: 25, color: "hsl(38, 70%, 50%)" },
  { name: "Co-Ords", value: 20, color: "hsl(20, 10%, 40%)" },
  { name: "Tops", value: 12, color: "hsl(30, 15%, 60%)" },
  { name: "Other", value: 8, color: "hsl(30, 10%, 80%)" },
];

const topProducts = [
  { name: "Champagne Sequin Evening Gown", sales: 142, revenue: 113358, trend: "up" },
  { name: "Emerald Velvet Blazer", sales: 98, revenue: 53802, trend: "up" },
  { name: "Ruby Gala Beaded Maxi Dress", sales: 87, revenue: 43413, trend: "down" },
  { name: "Black Paisley Long Cape", sales: 76, revenue: 53124, trend: "up" },
  { name: "Ivory Gold Embroidered Slip Dress", sales: 65, revenue: 25935, trend: "up" },
];

const recentOrders = [
  { id: "FS-20250227", customer: "Sara Ahmed", total: 1298, status: "Processing", time: "5 min ago" },
  { id: "FS-20250226", customer: "Fatima Noor", total: 799, status: "Shipped", time: "25 min ago" },
  { id: "FS-20250225", customer: "Ali Raza", total: 2150, status: "Delivered", time: "1 hr ago" },
  { id: "FS-20250224", customer: "Zainab Khan", total: 449, status: "Processing", time: "2 hrs ago" },
  { id: "FS-20250223", customer: "Hassan Malik", total: 1899, status: "Shipped", time: "3 hrs ago" },
];
...
const stats = [
  { label: "Total Revenue", value: "₨ 373,000", change: "+12.5%", up: true, icon: DollarSign, sub: "This month" },
  { label: "Total Orders", value: "1,059", change: "+8.2%", up: true, icon: ShoppingCart, sub: "This month" },
  { label: "Total Customers", value: "3,847", change: "+5.1%", up: true, icon: Users, sub: "Active users" },
  { label: "Total Products", value: "248", change: "+3", up: true, icon: Package, sub: "In catalog" },
];
